...
pub fn generate_schema(
    ...
    content.push_str("// This file is generated by Pyre. Do not edit by hand.\n\n");
    ...
    content.push_str("const database = (schemaName: string, schemaSource: string) => ({\n");
    content.push_str("  schemaSource,\n");
    content.push_str(
    ...
    for schema in &database.schemas {
        ...
        content.push_str(&format!(
            ...
            serde_json::to_string(&schema.namespace).expect("namespace should serialize"),
            serde_json::to_string(&source).expect("schema should serialize"),
        ));
    }
    content.push_str("} as const;\n");

    files.push(generate_text_file(
        base_out_dir.join("databases.ts"),
        content,
    ));

    generate_seed(context, base_out_dir, files);
}
...
fn generate_seed(
    ...
    content.push_str("import { seed as pyreSeed, type SeedResult, type SeedValidators } from '@pyre/server/query';\n");
    ...
    files.push(generate_text_file(base_out_dir.join("seed.ts"), content));
}
...
pub fn generate_queries(
    ...
    content.push_str("// This file is generated by Pyre. Do not edit by hand.\n\n");
    content.push_str(
        "import type { BatchManifest, QueryMap, QueryMetadata } from '@pyre/server/query';\n",
    );
    content.push_str("import { SessionValidator } from './core/decode';\n\n");
    ...
    content.push_str(&format!(
        ...
        serde_json::to_string(&crate::generate::manifest::compiled_schema_contract(
            context
        ))
        .expect("compiled schema contract")
    ));
    content.push_str(&format!(
        "export const replacementContracts = {};\n\n",
