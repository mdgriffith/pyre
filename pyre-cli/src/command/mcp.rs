...
fn tools() -> Vec<JsonValue> {
    vec![
        ...
        tool("pyre_docs", "Return bundled Pyre documentation by topic.", json!({"type":"object","properties":{"topic":{"type":"string","enum":["getting-started","schema","query","namespacing","sync","server-contexts","session-free-client","migrations","project-structure","serve","troubleshooting","mcp"]}}})),
