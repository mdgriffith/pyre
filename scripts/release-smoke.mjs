...
writeFileSync(
  ...
  [
    ...
    "import { namespace, scopedBatch, planKey } from '@pyre/core/local-edits';",
    ...
    "",
    "await init();",
    "if (typeof localEdits.bind !== 'function' || scopedBatch(namespace('smoke', 'manifest'))([])[planKey].operations.length !== 0) {",
    "  throw new Error('Local edit source exports are missing or incompatible');",
    "}",
    "",
